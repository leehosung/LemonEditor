...
-(id)initWithManager:(IUIdentifierManager *)identifierManager{
    ...
    if(self){
        ...
        [self.css setValue:@(80) forTag:IUCSSTagHeight forWidth:IUCSSDefaultCollection];
        [self.css setValue:@(350) forTag:IUCSSTagWidth forWidth:IUCSSDefaultCollection];
        [self.css setValue:nil forTag:IUCSSTagBGColor forWidth:IUCSSDefaultCollection];
